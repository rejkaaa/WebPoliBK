...
// fitur bisa tambah jadwal dihari yang sama dengan dokter lain namun jamnya tidak boleh bentrok
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Cek apakah waktu yang dimasukkan bentrok dengan jadwal lain dalam poli yang sama
    ...
    if (mysqli_num_rows($resultOverlap) > 0) {
        echo '<script>alert("Anda sudah mengambil jadwal di jam yang bentrok.");window.location.href="../../jadwalPeriksa.php";</script>';
    } else {
...
// tugas 2 ga bisa add jadwal dihari yang sama
// if ($_SERVER["REQUEST_METHOD"] == "POST") {
